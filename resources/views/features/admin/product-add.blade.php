                            ...
                            <div class="col-md-8 col-12">
                                <div class="card-add">
                                    ...
                                    <div class="mb-1 mt-1">
                                        ...
                                        <textarea class="tinymce" name="description" rows="6" placeholder="Description.."></textarea>
                                        <span class="error-content text-danger d-none"></span>
                                    </div>
                                    <div class="mb-1">
                                        <label for="tag" class="form-label">Tag</label>
                                        <textarea class="form-control input-custom" name="tag" rows="2" placeholder="tag.."></textarea>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="card-add ">
                                    ...
                                    <div class="justify-content-center text-center">
                                        <img id="blah" src="{{ asset('assets/img/no-images.png') }}" alt="your image"
                                            class="img-fluid img-product" /><br><br>
