...
@php
    $qa = json_decode($data->content, true);
@endphp
<form id="form-add-qa">
    @csrf
    <input type="hidden" value="{{ $data->id }}" name="id" value="id">
    <div class="modal-body">
        ...
        <div class="mb-1">
            ...
            <textarea type="text" class="form-control input-custom" placeholder="Enter Your Question" aria-label="question"
                aria-describedby="basic-addon1" id="question" name="question">{{ $qa['question'] }}</textarea>
