...
@section('content')
    ...
    <!-- modal -->
    <div class="modal fade bd-example-modal-md" tabindex="-1" role="dialog" id="modal-review"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("body").on("submit", "#form-add-review", function(e) {
                ...
                var form = document.getElementById('form-add-review');
            ...
            $("body").on("click", ".delete-button-review", function(e) {
                e.preventDefault();
            ...
            $("body").on("click", ".edit-button-review", function(e) {
                e.preventDefault();
                var id = $(this).data("id");
                $.ajax({
                    type: "GET",
