...
@section('title', 'Studion Session Memory')
@section('content')
    <section class="hero-wedding">
        <div class="content">
            <img src="{{ asset('assets/img/' . \App\Helpers\Helper::getBanner('Banner Studio Session')) }}" class="img-fluid"
    ...
    <section class="blog">
        <div class="container-fluid">
            ...
            <input type="hidden" value="Studio" name="category" id="category">
