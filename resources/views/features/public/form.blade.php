            ...
            <div class="row justify-content-center">
                <div class="col-md-auto col-12">
                    ...
                    <div class="content text-center mt-2">
                        ...
                        <a href="#">Surat Perjanjian Kerjasama Hieros 2024 - SPK/001/MMXXIV
                        </a>
                        <p class="h6 mt-4">
                            <span>
                            ...
                            <div class="form mt-5">
                                ...
                                <div class="mb-1 option">
                                    ...
                                    <select class="form-select form-select-sm" id="option"
                                        ...
                                        <option value="2 Days Bulding (Prewedding & Wedding)">2 Days Bundling (Prewedding &
                                            Wedding)</option>
                                        <option value="2 Days Bundling (Prewedding,Traditional Ceremony & Wedding)">2 Days
                                ...
                                <div class="mb-1 prewedding-content">
                                    ...
                                    <select class="form-select form-select-sm" id="prewedding-package"
                                        ...
                                        <option value="Prewedding at Hieros's Studio">Prewedding at Hieros's Studio</option>
                                ...
                                <div class="mb-1 wedding-content" style="display: none">
                                    ...
                                    <select class="form-select form-select-sm" id="wedding-package"
                                        ...
                                        <option value="Halftday Session (6 Hours)">Candid "Memorabilia" Package (8 Hours)
                                        </option>
                                        <option value="Fullday Session (15 Hours)">Fullday Session (15 Hours)</option>
                                        <option value="Prewedding at Hieros's Studio">Holy Matrimony / Akad Only (5 Hours)
                                        </option>
                                        <option value="Custom">Custom</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-select form-select-sm" id="list"
                                        ...
                                        <option
                                            ...
                                            selected>Saya mempercayakan backsound kepada Hieros & setuju tidak dapat diganti
                                            (revisi)</option>
                                        ...
                                        <option value="Saya tidak menggunakan video">Saya tidak menggunakan video</option>
                                    </select>
                                </div>
                                <div class="mb-1 url" style="display: none">
                                    <label for="urlVideo" class="form-label">List backsound untuk video saya (copas link)
                                    </label>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="agreement1">
                                            Saya secara sadar telah membaca dan menyetujui Surat Perjanjian Kerjasama Hieros
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="agreement2">
                                            Dengan ini saya yang namanya tercantum di atas, memberikan izin kepada Hieros
                                ...
                                <div class="mb-1 mt-4">
                                    <div class="row px-3">
                                        <button class="btn btn-purple is-rounded"><span class="mr-4"> <i
                                                    aria-disabled="true" class="fa fa-check-square-o"></i></span>Kirim Ke
                                            Herios Photograpy</button>
                                    </div>
                                </div>
                            </div>
                        </div>
