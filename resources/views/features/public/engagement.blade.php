...
@section('content')
    <section class="hero-wedding">
        <div class="content">
            <img src="{{ asset('assets/img/engagement-1.png') }}" class="img-fluid" alt="thumnail-weedding">
        </div>
    </section>
    <section class="blog">
            ...
            <div class="row mt-4">
                <div class="col-md-6 col-lg-4 col-12">
                    <div class="img-gallery">
                        <img src="{{ asset('assets/img/engagement-2.png') }}" alt="image-gallery-2" class="image-fluid">
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-12">
                    <div class="img-gallery">
